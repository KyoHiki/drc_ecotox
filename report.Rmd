...
if(input$model_218_mortality() == 'll2' & input$model_218_emergence() == 'll2' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll2' & input$model_218_emergence() == 'll2' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll2' & input$model_218_emergence() == 'll3' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll2' & input$model_218_emergence() == 'll3' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll2' & input$model_218_emergence() == 'll4' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll2' & input$model_218_emergence() == 'll4' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll3' & input$model_218_emergence() == 'll2' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll3' & input$model_218_emergence() == 'll2' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll3' & input$model_218_emergence() == 'll3' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll3' & input$model_218_emergence() == 'll3' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll3' & input$model_218_emergence() == 'll4' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll3' & input$model_218_emergence() == 'll4' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll4' & input$model_218_emergence() == 'll2' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll4' & input$model_218_emergence() == 'll2' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll4' & input$model_218_emergence() == 'll3' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll4' & input$model_218_emergence() == 'll3' & input$model_218_development() == 'll4' ) {
...
} else if(input$model_218_mortality() == 'll4' & input$model_218_emergence() == 'll4' & input$model_218_development() == 'll3' ) {
...
} else if(input$model_218_mortality() == 'll4' & input$model_218_emergence() == 'll4' & input$model_218_development() == 'll4' ) {
...
　　　 par(mar=c(5,5,2,2), mfrow=c(3,1),mgp=c(3, 1, 0) )
      knitr::opts_chunk$set(fig.width=5, fig.height=18) 
      plot(fit1, log="x", broken=TRUE, xlab=paste0("Concentration (", input$conc_unit, ")"), ylab="Mortality",
           ylim=c(0,1),lty="dotted",cex=1.5,cex.axis =1.5, cex.lab=1.5)
      ...
      plot(fit3, log="x", broken=TRUE, xlab=paste0("Concentration (", input$conc_unit, ")"), ylab="Development rate",
           lty="dotted",cex=2,cex.axis =1.5, cex.lab=1.5)
    } else if(input$test_type == 'TG235') {
      fit <- fitmodel()
      fit1 <- fit$fit1
      fit2 <- fit$fit2
...
print("Homogenity of variance is checked by Bartlett's test, which tests the null hypothesis that the variance at each concentration is the same.")
print("If the null hypothesis is not rejected, NOEC can be estimated using Dunnett's test.")
print("If the null hypothesis is rejected, NOEC can be estimated using Steel's test.")
}
TestResult()
```
