...
if(input$test_type == 'TG201'){
  ...
  if(input$endpoint_TG221 =='Number'){
    print("Endpoint: Frond number")
  } else if(input$endpoint_TG221 =='Area') {
    print("Endpoint: Total frond area")
  }
...
```{r plot, collapse=TRUE, echo=FALSE ,fig.width=6.3, fig.height=5}
 if(input$test_type == 'TG201') {
      print("Growth rate for 72 hours")
