...
if(input$test_type == 'TG201'){
  ...
  writeLens("Selected model: Log-logistic 2 parameters \n")
  } else if (input$model_TG201 =='ll4'){
    writeLens("Selected model: Log-logistic 4 parameters \n")
    }
} else if(input$test_type == 'TG235'){
  if(input$model_TG235 =='ll2'){
  writeLines("Selected model: Log-logistic 2 parameters \n")
  } else if (input$model_TG235 =='ll4'){
    writeLens("Selected model: Log-logistic 4 parameters \n")
    }
}
print(knitr::kable(ECx()) )
```
